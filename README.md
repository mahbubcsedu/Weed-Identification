...
2.1 Sing in to the system 5

2.2 Sign up for the system 6

2.3 Weed database 8

2.4 User profile 9

2.5 User instruction 9

2.6 Image Zoom 10

Farmer Specific Features 10
3.1 Add a request 11

3.2 Review previous requests (list) 12

3.3 Review previous requests (map) 13

3.4 Detail response 14

3.5 Sign out 15

Expert Specific Features 15
4.1 Farmer's requests (list & map view) 16

4.2 Request diagnosis 17

4.3 Add new weed information 18

4.4 Review the response 20

App admin Specific Features 21
...
4.1Farmer's requests (list & map view)
