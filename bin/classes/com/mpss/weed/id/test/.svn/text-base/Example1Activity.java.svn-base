...
import com.mpss.weed.id.utils.QuickAction.OnActionItemClickListener;
import com.mpss.weed.id.utils.QuickAction.OnDismissListener;
...
public class Example1Activity extends Activity {
	...
	private static final int Test1 = 4;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionItem test1 	= new ActionItem(Test1, "Test", getResources().getDrawable(R.drawable.ic_up));
        ActionItem test2 	= new ActionItem(Test2, "Test2", getResources().getDrawable(R.drawable.ic_up));
		...
		mQuickAction.addActionItem(test1);
		mQuickAction.addActionItem(test2);
