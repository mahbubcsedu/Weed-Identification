...
$cmd="java -jar /var/www/smsdb/weed_app/executable/propertiesofHIT.jar" ." \"".$_POST['_hittitle']."\"  "."       ". "    \" ".$_POST['_hitdescription']."\"      "."  \"" .$_POST['_hitkeyword']."\"  "."  " .$_POST['_hitrewards']."    " .$_POST['_hitNumOfAssign'] ."    " .$_POST['_hitassDuration'];
$files=array();
exec($cmd,$files);
echo $cmd;	
echo '<pre>';
