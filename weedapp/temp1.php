...
<label> Image ID </label>
    ...
    <select id='gallery_id' name='gallery_id'  title="Creating HIT" onChange="window.location='temp1.php?imageid='+this.value" style='width:200px;' >
    <?php
    echo  "folder ".$folder;
  ...
  ?>
    ...
    <img height="320" width="240" title='.$item' src=' <?=$folder.$item?> '/>
...
function createhitfromhere(){
$cmd="php /var/www/smsdb/weed_app/weedapp/hitcreate.php /var/www/smsdb/weed_app/weedapp/Image_Capture/".$item .$_POST['NumOfImages']." 101 ";
$files=array();
exec($cmd,$files);
echo 'comvvv';	
