...
if($code == "54m3xuzm97z30rdfsloegjizvzgga12bshptv59o")
{
	...
	$insertquery="INSERT INTO farmer_profile (first_name, last_name, user_name, fpassword, location, member_since, last_activity, county) VALUES ('$firstname', '$lastname', '$username', '$fpassword', '$location', '$date', '$datetime', '$county')";
