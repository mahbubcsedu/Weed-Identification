...
//{
	...
	if(empty($_FILES['audio']['name']))
	{
		...
		$cur_dir=getcwd();
		$target_path_audio=$cur_dir."/Audio_Capture/";
		//$target_path_audio=getcwd()"/var/www/smsdb/weed_app/weedapp/Audio_Capture/";
...
//echo exec("php ./send_notification.php 123");
$base=$_REQUEST['image'];
...
fwrite($file, $binary);
fclose($file);
echo 'Image upload complete!!, $imagename :Please check your php file directoryÃ¢â‚¬Â¦Ã¢â‚¬Â¦';
...
$Handle = fopen($File, 'a');
$Data =  "Image Url:".$imagename."  time to run:".$totaltime." seconds\n";
fwrite($Handle, $Data);
fclose($Handle);
