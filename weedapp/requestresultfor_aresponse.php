<?php
	...
	if($result && mysql_numrows($result)>0)
	{
		...
		while ($db_locations = mysql_fetch_assoc($result))
		{
			...
			$weed = array('weed_id' => $weedid, 'common_name' => $commonname, 'latin_name' => $latinname,'rank'=> $rank, 'weed_type' => $weedtype, 'life_cycle' => $lifecycle, 'season' => $season, 'site' => $site, 'prof_control' => $profcontrol, 'home_control' => $homecontrol, 'image_url' => $image_url);
