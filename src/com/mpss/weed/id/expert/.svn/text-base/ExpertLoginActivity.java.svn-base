...
public class ExpertLoginActivity extends Activity {
	...
	public void attemptLogin(String user, String fpassword) {
		...
		progress.show();
		String temp = "http://mpss.csce.uark.edu/~mweathers/weedapp/loginexpert.php?code=54m3xuzm97z30rdfsloegjizvzgga12bshptv59o";
